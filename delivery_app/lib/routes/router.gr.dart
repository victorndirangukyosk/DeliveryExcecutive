...
class AppRouter extends _i6.RootStackRouter {
  ...
  List<_i6.RouteConfig> get routes => [
        ...
        _i6.RouteConfig(MainHomeRoute.name, path: '/main-home-page'),
        _i6.RouteConfig(SingleOrderRoute.name, path: '/single-order-page'),
        _i6.RouteConfig(ReadyForDelivery.name, path: '/ready-for-delivery')
      ];
}
...
class SingleOrderRoute extends _i6.PageRouteInfo<void> {
...
class ReadyForDelivery extends _i6.PageRouteInfo<void> {
