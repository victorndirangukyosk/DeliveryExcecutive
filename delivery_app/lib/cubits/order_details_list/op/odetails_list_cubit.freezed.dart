...
class __$$_InitialCopyWithImpl<$Res>
    extends _$OdetailsListStateCopyWithImpl<$Res>
...
class _$_Success implements _Success {
  const _$_Success(
      ...
      : _odetailsList = odetailsList,
        _status = status;

  final List<OdetailsList>? _odetailsList;
  @override
  List<OdetailsList>? get odetailsList {
    final value = _odetailsList;
    if (value == null) return null;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<ProcessedProducts>? _status;
  @override
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._odetailsList, _odetailsList) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_odetailsList),
