...
mixin _$AssignedDe {
  ...
  @JsonKey(ignore: true)
  $AssignedDeCopyWith<AssignedDe> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AssignedDeCopyWith<$Res> {
  factory $AssignedDeCopyWith(
          AssignedDe value, $Res Function(AssignedDe) then) =
      _$AssignedDeCopyWithImpl<$Res>;
  $Res call(
      {String? order_status,
      num? products_count,
...
/// @nodoc
class _$AssignedDeCopyWithImpl<$Res> implements $AssignedDeCopyWith<$Res> {
  _$AssignedDeCopyWithImpl(this._value, this._then);

  final AssignedDe _value;
  // ignore: unused_field
  final $Res Function(AssignedDe) _then;
  ...
  $Res call({
    ...
    Object? shopper_distance = freezed,
    ...
    return _then(_value.copyWith(
      ...
      comment: comment == freezed
          ...
          : comment // ignore: cast_nullable_to_non_nullable
              as String?,
      shipping_address: shipping_address == freezed
          ? _value.shipping_address
          : shipping_address // ignore: cast_nullable_to_non_nullable
              as String?,
      shopper_distance: shopper_distance == freezed
          ? _value.shopper_distance
          : shopper_distance // ignore: cast_nullable_to_non_nullable
              as num?,
...
/// @nodoc
@JsonSerializable()
class _$_AssignedDe implements _AssignedDe {
  _$_AssignedDe(
      {this.order_status,
      this.products_count,
      this.delivery_date,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.shopper_distance, shopper_distance) &&
            const DeepCollectionEquality()
