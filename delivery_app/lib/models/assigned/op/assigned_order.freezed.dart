...
class _$_AssignedOrder implements _AssignedOrder {
  ...
  @override
  String toString() {
    return 'AssignedOrder(order_status: $order_status, products_count: $products_count, delivery_date: $delivery_date, delivery_timeslot: $delivery_timeslot, comment: $comment, order_id: $order_id, order_processing_group_id: $order_processing_group_id, order_processor_id: $order_processor_id)';
  }
